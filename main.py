...
def generate_water_summary(inburi_raw, c13_raw):
    prompt = f"""
    รายงานสถานการณ์น้ำ อ.อินทร์บุรี วันนี้ (31 มี.ค. 2569)
    ...
    2. ต้องระบุ: ระดับน้ำปัจจุบัน ม.รทก. ของสถานี C.3 และ "ห่างจากตลิ่งกี่เมตร" (ตลิ่งอินทร์บุรีสูง 15.10 ม.)
    3. ต้องระบุ: ปริมาณการระบายน้ำของเขื่อนเจ้าพระยา (C.13) วันนี้ และ "เปรียบเทียบกับเมื่อวาน"
